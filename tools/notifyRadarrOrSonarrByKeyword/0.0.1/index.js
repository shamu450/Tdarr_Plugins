// modify to allow user to enter keywords to search for in file name
// to indicate if it is tv or movie then update the proper *arr
// let the user enable keywords per arr with toggle to turn on or off
// text area to accept 1 keyword per arr
...
var details = function () { return ({
    ...
    icon: 'faBell',
    inputs: [
        { //add input for keyword 1 input per *arr
            label: 'Arr', // change to toggle to enable *arr 1 per *arr
            name: 'arr',
            type: 'string',
            defaultValue: 'radarr',
            inputUI: {
        ...
        {
            label: 'Arr API Key', // 2 api input one per *arr
            name: 'arr_api_key',
            type: 'string',
            defaultValue: '',
            inputUI: {
        ...
        {
            label: 'Arr Host', // 2 arr host inputs 1 per *arr
            name: 'arr_host',
            type: 'string',
...
var getId = function (args, arrApp, fileName) { return __awaiter(void 0, void 0, void 0, function () {// change name to getType and remove unneeded and make function to determine if in radarr or sonarr from keywords
